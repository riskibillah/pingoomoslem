function rpthumbnt(json) {
 document.write('<ul class="w2b_recent_comments">');
...
function rpnewsticker() {
 last = $('ul#w2b_recent_comments li:last').hide().remove();
 $('ul#w2b_recent_comments').prepend(last);
 $('ul#w2b_recent_comments li:first').slideDown("slow")
}
